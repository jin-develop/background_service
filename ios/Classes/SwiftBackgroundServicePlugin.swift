...
public class SwiftBackgroundServicePlugin: FlutterPluginAppLifeCycleDelegate, FlutterPlugin  {
    ...
    public func beginFetch(){
        ...
        if let callbackHandleID = defaults.object(forKey: "callback_handle") as? Int64 {
            ...
            SwiftBackgroundServicePlugin.flutterPluginRegistrantCallback?(self.backgroundEngine!)
